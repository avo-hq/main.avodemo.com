class Avo::Resources::Fish < Avo::BaseResource
  ...
  self.show_controls = -> do
    ...
    link_to "Fish.com", "https://fish.com", icon: "tabler/outline/school", target: :_blank
    ...
    action Avo::Actions::ReleaseFish, style: :primary, color: :fuchsia, icon: "tabler/outline/world"
    edit_button label: ""
  end
  ...
  self.edit_controls = -> do
    ...
    detach_button label: "", title: "something"
    actions_list exclude: [Avo::Actions::ReleaseFish], style: :primary, color: :slate, label: "Runnables"
    action Avo::Actions::ReleaseFish, style: :primary, color: :fuchsia, icon: "tabler/outline/world" if view != :new
  ...
  self.index_controls = -> do
    ...
    action Avo::Actions::Dummy, style: :primary, color: :fuchsia, icon: "tabler/outline/world" if Fish.count > 0
    attach_button label: "Attach one Fish"
    create_button label: "Create a new and fresh Fish"
  end

  self.row_controls = -> do
    action Avo::Actions::ReleaseFish, label: "Release #{record.name}", style: :primary, color: :blue, icon: "tabler/outline/hand-stop" unless params[:view_type] == "grid"
    ...
    action Avo::Actions::ReleaseFish, title: "Release #{record.name}", icon: "tabler/outline/hand-stop", style: :icon
    link_to "Information about #{record.name}", "https://en.wikipedia.org/wiki/#{record.name}",
      icon: "tabler/outline/info-circle", target: :_blank, style: :icon
  end
  ...
  def fields
    ...
    tabs do
      ...
      tab title: "big useless tab here 2" do
        panel do
          field :id, as: :id
        end
      end

      tab title: "big useless tab here 3" do
        panel do
          field :id, as: :id
        end
      end

      tab title: "big useless tab here 4" do
        panel do
          field :id, as: :id
        end
      end

      tab title: "big useless tab here 5" do
        panel do
          field :id, as: :id
        end
      end
      ...
      tab title: "big useless tab here 8" do
        panel do
          field :id, as: :id
        end
      end
